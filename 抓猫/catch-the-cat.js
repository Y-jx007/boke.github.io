<link rel="stylesheet" class="aplayer-secondary-style-marker" href="\assets\css\APlayer.min.css"><script src="\assets\js\APlayer.min.js" class="aplayer-secondary-script-marker"></script>!(function (t) {
      ...
      return (
        ...
        (e.prototype.preload = function () {
          ...
          for (var e in s.default.textures)
            this.load.addFile(
              new c.default(this.load, e, s.default.textures[e], {
                scale: t,
              })
            );
        }),
        ...
        (e.prototype.getBlock = function (t, e) {
          return t >= 0 && t < this.w && e >= 0 && e < this.h
            ? this.blocks[t][e]
            : null;
        }),
        (e.prototype.playerClick = function (t, e) {
          if (
            (this.cat.anims.isPlaying && this.cat.anims.stop(),
            this.state !== i.PLAYING)
          )
            return (
              this.setStatusText(f.default("游戏已经结束，重新开局")),
              this.reset(),
              !1
            );
          ...
          return n
            ? n.isWall
              ? (this.setStatusText(f.default("点击位置已经是墙了，禁止点击")),
                !1)
              : this.cat.i === t && this.cat.j === e
              ? (this.setStatusText(
                  f.default("点击位置是猫当前位置，禁止点击")
                ),
                !1)
              : ((n.isWall = !0),
                this.cat.isCaught()
                  ...
                  : (this.setStatusText(
                    ...
                    this.cat.step() ||
                      (this.setStatusText(f.default("猫认输，你赢了！")),
                      (this.state = i.WIN)),
                    !0))
        ...
        (e.prototype.randomWall = function () {
          for (var t = 0; t < 8; t++) {
            ...
            (e === this.cat.i && n === this.cat.j) ||
              (this.getBlock(e, n).isWall = !0);
          }
        }),
        e
      );
    ...
    var i = n(0),
      s = (function (t) {
        function e(e) {
          ...
          return (
            ((n = t.call(this, u) || this).myConfig = e), (n.mainScene = h), n
          );
        }
        return (
          r(e, t),
      ...
      l = (function (t) {
        ...
        return (
          ...
          (e.prototype.step = function () {
            ...
            return t < 0 || t > 6
              ? (this.caught(), !1)
              : !!this.stepDirection(t) || (this.caught(), !1);
          }),
          ...
          (e.prototype.caught = function () {
            this.setTexture(
              s.default.cannotEscapeTextures[
                s.default.directions[this.direction].name
              ]
            );
          }),
          ...
          (e.prototype.resetIJ = function () {
            this.setIJ(
              Math.floor(this.scene.w / 2),
              Math.floor(this.scene.h / 2)
            );
          }),
          ...
          (e.prototype.checkState = function () {
            this.isEscaped()
              ? (this.escape(), this.emit("escaped"))
              : this.isCaught() && (this.caught(), this.emit("win"));
          }),
          ...
          (e.prototype.resetTextureToStop = function () {
            this.setTexture(
              s.default.stopTextures[s.default.directions[this.direction].name]
            );
          }),
      ...
      function e(e) {
        ...
        return (
          ...
          "center" === e.game.myConfig.statusBarAlign &&
            (n.setX(e.game.canvas.width / 2), n.setOrigin(0.5, 0)),
          n.setPadding(o, o, o, o),
          n
        );
      }
              ...
              if (void 0 === this._routesCount)
                if (this.isEdge) this._routesCount = 1;
                  ...
                  this.neighbours.forEach(function (n) {
                    null === n ||
                      n.isWall ||
                      (n.distance < t.distance && (e += n.routesCount));
                  }),
                    (this._routesCount = e);
                }
            ...
            get: function () {
              ...
              return (
                this.neighbours.forEach(function (n, o) {
                  null === n ||
                    n.isWall ||
                    (n.distance < t.distance && e.push(o));
                }),
                e
              );
            },
        ...
        return (
          ...
          (e.prototype.load = function () {
            this.state === Phaser.Loader.FILE_POPULATED
              ...
              : (this.xhrLoader = i.default(this, this.loader.xhr));
          }),
          e
        );
  ...
  function (t, e, n) {
    ...
    e.default = function (t, e) {
      ...
      return (
        ...
        e.header &&
          e.headerValue &&
          n.setRequestHeader(e.header, e.headerValue),
        e.requestedWith &&
          n.setRequestHeader("X-Requested-With", e.requestedWith),
  ...
  function (t, e, n) {
    ...
    function a() {
      ...
      for (
        var t = ["loadstart", "progress", "load", "abort", "loadend"],
          e = t.length - 1;
        e >= 0;
        e--
      )
    ...
    (a.prototype = {
      ...
      removeEventListener: function (t, e) {
        for (
          var n = this._eventListeners[t] || [], o = 0, r = n.length;
          o < r;
          ++o
        )
          if (n[o] == e) return n.splice(o, 1);
      },
      dispatchEvent: function (t) {
        for (
          var e = t.type, n = this._eventListeners[e] || [], o = 0;
          o < n.length;
          o++
        )
    ...
    var d = {
      ...
      setRequestHeader: function (t, e) {
        if ((u(this), i[t] || /^(Sec-|Proxy-)/.test(t)))
      ...
      abort: function () {
        (this.aborted = !0),
          ...
          this.readyState > l.UNSENT &&
            this.sendFlag &&
            (this._readyStateChange(l.UNSENT), (this.sendFlag = !1)),
      ...
      getResponseHeader: function (t) {
        ...
        for (var e in ((t = t.toLowerCase()), this.responseHeaders))
          if (e.toLowerCase() == t) return this.responseHeaders[e];
        return null;
      },
      getAllResponseHeaders: function () {
        ...
        for (var e in this.responseHeaders)
          this.responseHeaders.hasOwnProperty(e) &&
            !/^Set-Cookie2?$/i.test(e) &&
            (t += e + ": " + this.responseHeaders[e] + "\r\n");
        return t;
      },
      ...
      _readyStateChange: function (t) {
        (this.readyState = t),
          "function" == typeof this.onreadystatechange &&
            this.onreadystatechange(new o("readystatechange")),
          this.dispatchEvent(new o("readystatechange")),
          this.readyState == l.DONE &&
            this.dispatchEvent(new o("load", !1, !1, this)),
          (this.readyState != l.UNSENT && this.readyState != l.DONE) ||
            this.dispatchEvent(new o("loadend", !1, !1, this));
      },
      _setResponseHeaders: function (t) {
        for (var e in ((this.responseHeaders = {}), t))
          t.hasOwnProperty(e) && (this.responseHeaders[e] = t[e]);
        this.forceMimeType &&
          (this.responseHeaders["Content-Type"] = this.forceMimeType),
          this.async
            ? this._readyStateChange(l.HEADERS_RECEIVED)
      ...
      _setResponseBody: function (t) {
        ...
        if (
          this.responseText &&
          (!i || /(text\/xml)|(application\/xml)|(\+xml)/.test(i))
        )
          try {
            this.responseXML =
              ((o = this.responseText),
              "undefined" != typeof DOMParser
                ...
                : (((r = new ActiveXObject("Microsoft.XMLDOM")).async =
                    "false"),
                  r.loadXML(o)),
              r);
          } catch (t) {}
        this.async
          ? this._readyStateChange(l.DONE)
          : (this.readyState = l.DONE);
      },
